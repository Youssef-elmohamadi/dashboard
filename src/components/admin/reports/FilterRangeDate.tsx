  ...
  return (
    <div className="rounded-2xl border mb-5 border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
      <div className="gap-4 px-6 py-5 flex-row items-center justify-between">
        ...
        <div className="border-t border-gray-200  dark:border-gray-800 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 max-w-5xl p-4">
          <div>
            ...
            <input
              ...
              className="w-full border border-gray-200 dark:border-gray-800 rounded px-3 py-2 text-gray-900 dark:text-gray-200 text-sm outline-none"
            />
          </div>
          <div>
            <label className="block text-sm font-medium mb-3 dark:text-white">

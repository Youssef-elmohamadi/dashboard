...
const LandingSection = () => {
  ...
  const backgroundAlt =
    lang === "ar"
      ? "الصفحة الرئيسية لتشطيبة -  حل متكامل لتشطيب بيتك خدمات منتجات استشارات"
      : "Tashtiba Home - One-Stop Solution for Home Finishing Services Products Consultations";

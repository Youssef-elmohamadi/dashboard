...
const CartPopup = lazy(() => import("./CartPopup"));
...
const NavBar = React.memo(() => {
  ...
  return (
    <nav className="end-user-bg-secondary w-full min-h-18 md:flex items-center hidden">
      <div className="flex enduser_container w-full justify-center lg:justify-baseline items-center relative">
        <Suspense fallback={null}>
          <CategoriesDropdown lang={lang} dir={dir} />
        </Suspense>

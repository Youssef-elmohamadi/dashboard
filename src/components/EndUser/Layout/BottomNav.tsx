...
const BottomNav = () => {
  ...
  return (
    <div className="flex justify-center items-center ">
      <div className="lg:hidden flex h-20 w-[600px] max-w-full fixed bottom-5 rounded-4xl justify-between items-center px-5 py-2 bg-[rgba(255,255,255,0.9)] border border-gray-200 z-10 shadow-md z-50">
        {/* Home NavLink */}
        ...
        {isLoggedIn && (
          <div className="w-1/5 flex flex-col items-center justify-center">
            ...
            >
              ...
              <span className="text-xs mt-1 transition-colors duration-300">
                {t("Common:BottomNav.notifications")}
              </span>
            </NavLink>
          </div>
        )}

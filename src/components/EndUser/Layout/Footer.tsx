    ...
    <footer className="bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white px-6 py-14 shadow-inner">
      <div className="max-w-7xl mx-auto space-y-16">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8 border-t border-gray-700 pt-10">
          {/* Quick Links */}
          <FooterSection
            title={t("Common:Footer.quick_links")}
          ...
          >
            <ul className="text-sm space-y-2 text-gray-300">
              <li className="flex items-center gap-2">
                ...
                <span>{t("Common:Footer.contact.location")}</span>
              </li>
              <li className="flex items-center gap-2">
          ...
          <FooterSection
            title={t("Common:Policies.heading")}
          ...
          {/* My Account */}
          <FooterSection
            title={t("Common:Footer.blogs.title")}
            isOpen={blogsOpen}
          ...
          {/* Seller Portal */}
          <FooterSection
            title={t("Common:Footer.seller_zone.title")}
            ...
            <ul className="text-sm space-y-1">
              <li>
                ...
                >
                  ...
                  {t("Common:Footer.seller_zone.join")}
                </Link>
              </li>
            </ul>
          </FooterSection>
        ...
        <div className="border-t border-gray-700 pt-6 flex justify-center items-center text-sm text-gray-400">
          <p
            dangerouslySetInnerHTML={{
              __html: t("Common:Footer.rights_reserved"),
            }}
          />

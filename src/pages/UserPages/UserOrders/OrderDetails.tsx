          ...
          {!id ? (
            ...
            <>
              ...
              {order.sub_orders.map((subOrder) => (
                ...
                >
                  ...
                  <div className="mt-4 text-sm space-y-1 text-gray-700">
                    ...
                    <p>
                      <span className="font-semibold">
                        {t("orderDetails.shipping_price")}:
                      </span>{" "}
                      {order?.transportation_price?.toLocaleString() || 0}{" "}
                      {t("orderDetails.egp")}
                    </p>
                    ...
                    <p className="font-semibold text-base">
                      ...
                      {order?.transportation_price ? (subOrder.total + order?.transportation_price ).toLocaleString():subOrder.total.toLocaleString() } {t("orderDetails.egp")}
                    </p>
                  </div>
                </div>
              ))}
              ...
              <div className="text-right font-bold text-xl mt-8 border-t border-gray-200 pt-4 text-gray-800">
                ...
                {order?.transportation_price ? (order.total_amount + order?.transportation_price ).toLocaleString():order.total_amount.toLocaleString() } {t("orderDetails.egp")}
              </div>
            </>
          )}
        </div>
